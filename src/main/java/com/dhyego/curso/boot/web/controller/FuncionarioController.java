...
import com.dhyego.curso.boot.domain.UF;
import com.dhyego.curso.boot.service.CargoService;
import com.dhyego.curso.boot.service.FuncionarioService;
import com.dhyego.curso.boot.web.validator.FuncionarioValidator;
...
public class FuncionarioController {
    ...
    public String getPorCargo(@RequestParam(value = "id", required = false) Long id, ModelMap model) {
